...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void countDownTimer(){
        new CountDownTimer(10000,1000) {
            ...
            public void onFinish(){
                Toast.makeText(MapsActivity.this, "Actualizando ubicación", Toast.LENGTH_SHORT).show();
                onMapReady(mMap);
            }
        }.start();
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        mDatabase.child("Ubicación").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){ //obtener los hijos del modo Ubicación
